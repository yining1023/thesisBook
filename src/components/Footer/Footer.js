  ...
  return (
    <footer className={`mdl-mini-footer ${s.footer}`}>
      <div className="mdl-mini-footer__left-section">
        <div className="mdl-logo">© ITP NYU</div>
      </div>
      <div className="mdl-mini-footer__right-section">
        <ul className="mdl-mini-footer__link-list">
          <li className="mdl-mini-footer--social-btn" style={{ backgroundColor: 'transparent' }}>
            <a href="https://github.com/yining1023/thesisBook" role="button" title="GitHub">
          ...
          <li className="mdl-mini-footer--social-btn" style={{ backgroundColor: 'transparent' }}>
            <a href="https://twitter.com/ITP_NYU" role="button" title="Twitter">
              <svg width="24" height="24" viewBox="0 0 24 24">
                <path
